...
## Часть III: минимальный клон игры DoodleJump

В примере новые возможности добавляются отдельными слоями. Каждый пример сопровождается статьей и имеет свой каталог [в репозитории sfml-doodlejump](https://github.com/ps-group/sfml-doodlejump).

- [Создаём проект, окно и управляемый прямоугольник](/doodlejump/1.html)
- [Подключаем камеру и пишем генератор плит](/doodlejump/2.html)
